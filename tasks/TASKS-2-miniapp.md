...
### [x] Задача 2.2 — Авторизация в Mini App
...
### [x] Задача 2.5 — Система сохранения прогресса (Draft)
...
### [x] Задача 2.6 — Пагинация

> **Обновлено 2026-02-17:** Добавлена "Load more" пагинация во все основные списки
...
- [x] `ParticipantSection` — кнопка "Загрузить ещё" (page size = 20) **ДОБАВЛЕНО 2026-02-17**
- [x] Создатель `CreatorDashboardPage` — кнопка "Загрузить ещё" (page size = 20) **ДОБАВЛЕНО 2026-02-17**
- ⚠️ Offset-based вместо cursor-based — работает корректно для MVP
...
### [x] Задача 2.10 — Синхронизация между устройствами
